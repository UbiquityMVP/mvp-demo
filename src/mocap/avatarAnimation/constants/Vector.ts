import { AxisMap, EulerRotation, PI, TWO_PI, XYZ } from './Types';
...
export default class Vector {
  ...
  constructor(
    a?: number[] | XYZ | number | Vector | EulerRotation,
    b?: number,
    c?: number,
  ) {
    if (Array.isArray(a)) {
  ...
  static lerp<T extends number | Vector>(a: T, b: T, fraction: number): T {
    if (b instanceof Vector) {
      ...
      return (((b as number) - (a as number)) * fraction +
        (a as unknown as number)) as unknown as T;
    }
  }
  /**
